...
This directory contains the results of running the nfcore_real integration test.
...
diff -u ../../test/integration/trim/nfcore_real/expected_R1.fastq /tmp/out_R1.fastq > ../../test/integration/trim/nfcore_real/results/diff_R1.txt
diff -u ../../test/integration/trim/nfcore_real/expected_R2.fastq /tmp/out_R2.fastq > ../../test/integration/trim/nfcore_real/results/diff_R2.txt
```
...
- The integration test uses real data from GSE110004 (SRR6357070)
- For more information about the dataset, see the parent directory README.md
